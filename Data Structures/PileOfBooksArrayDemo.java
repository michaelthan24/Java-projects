 ...
 * Michael Than
 * Bronco ID: 012592802
 * This class uses the PileOfBookArray.java to demonstrate how resizable arrays work for the pile
 * 
 */
import java.util.Scanner;
public class PileOfBooksArrayDemo {
	public static void main(String [] args) {
		PileOfBooksBag<String> pile = new PileOfBooksArray<>(); //creates the new pile
		testIsEmpty(pile, true);// checks if the array is indeed empty
		displayPileOfBooks(pile);//displays that the bag/pile is empty
		System.out.println("Let's start up a pile of books Using a resizable array. Enter "
		...
		String[] inputBookArray = new String[numBooks];
		for (int index=0;index<numBooks;index++) {//takes in the titles of the books added to the pile
			...
			inputBookArray[index]=inBook.nextLine();
		} //end for loop
		System.out.println();
		testAdd(pile, inputBookArray); //adds the books user inputed and puts them in the bag
	...
	//tests add method but using array resizing
	private static void testAddResize(PileOfBooksBag<String> pile, String bookAdd) {
