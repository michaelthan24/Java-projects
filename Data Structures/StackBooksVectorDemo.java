 ...
 * Michael Than
 * ID:12593802
 * This class demonstrates the StackBooksVector class
 */
public class StackBooksVectorDemo {
	public static void main(String [] args) {
		StackBooksInterface<String> stack = new StackBooksVector<>(); //creates the new stack
		testIsEmpty(stack, true);// checks if the stack is indeed empty
		System.out.println("Let's start up a stack of books Using a vector. Enter "
