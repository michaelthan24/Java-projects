 ...
 * Michael Than
 * ID: 012593802
 * This class is a demonstration of the use of the StackBooksLinked class
 * 
 */
public class StackBooksLinkedDemo {
	
	public static void main(String [] args) {
		StackBooksInterface<String> stack = new StackBooksLinked<>(); //creates the new stack
		testIsEmpty(stack, true);// checks if the stack is indeed empty
		System.out.println("Let's start up a stack of books using a linked list. Enter "
